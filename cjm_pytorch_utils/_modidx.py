...
d = { 'settings': { 'branch': 'main',
  ...
  'syms': { 'cjm_pytorch_utils.core': { 'cjm_pytorch_utils.core.ImageDataset': ('core.html#imagedataset', 'cjm_pytorch_utils/core.py'),
                                        'cjm_pytorch_utils.core.ImageDataset.__getitem__': ( 'core.html#imagedataset.__getitem__',
                                                                                             'cjm_pytorch_utils/core.py'),
                                        'cjm_pytorch_utils.core.ImageDataset.__init__': ( 'core.html#imagedataset.__init__',
                                                                                          'cjm_pytorch_utils/core.py'),
                                        'cjm_pytorch_utils.core.ImageDataset.__len__': ( 'core.html#imagedataset.__len__',
                                                                                         'cjm_pytorch_utils/core.py'),
                                        'cjm_pytorch_utils.core.compute_mean_std': ( 'core.html#compute_mean_std',
                                                                                     'cjm_pytorch_utils/core.py'),
                                        'cjm_pytorch_utils.core.denorm_img_tensor': ( 'core.html#denorm_img_tensor',
                                                                                      'cjm_pytorch_utils/core.py'),
                                        ...
                                        'cjm_pytorch_utils.core.iterate_modules': ( 'core.html#iterate_modules',
                                                                                    'cjm_pytorch_utils/core.py'),
                                        'cjm_pytorch_utils.core.move_data_to_device': ( 'core.html#move_data_to_device',
                                                                                        'cjm_pytorch_utils/core.py'),
